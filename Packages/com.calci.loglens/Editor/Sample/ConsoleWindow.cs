...
//             
//             iconInfo = EditorGUIUtility.Load("icons/console.infoicon") as Texture2D;
//             iconWarn = EditorGUIUtility.Load("icons/console.warnicon") as Texture2D;
//             iconError = EditorGUIUtility.Load("icons/console.erroricon") as Texture2D;
//             iconInfoSmall = EditorGUIUtility.Load("icons/console.infoicon.sml") as Texture2D;
//             iconWarnSmall = EditorGUIUtility.Load("icons/console.warnicon.sml") as Texture2D;
//             iconErrorSmall = EditorGUIUtility.Load("icons/console.erroricon.sml") as Texture2D;
//             iconInfoMono = EditorGUIUtility.Load("icons/console.infoicon.inactive.sml") as Texture2D;
//             iconWarnMono = EditorGUIUtility.Load("icons/console.warnicon.inactive.sml") as Texture2D;
//             iconErrorMono = EditorGUIUtility.Load("icons/console.erroricon.inactive.sml") as Texture2D;
//             Constants.Init();
//         }
//
